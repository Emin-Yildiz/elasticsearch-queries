package com.example.searchservice.user.repository;
...
import com.example.searchservice.user.model.response.UserElasticCdcModel;
import com.example.searchservice.util.ElasticSearchQueryUtil;
